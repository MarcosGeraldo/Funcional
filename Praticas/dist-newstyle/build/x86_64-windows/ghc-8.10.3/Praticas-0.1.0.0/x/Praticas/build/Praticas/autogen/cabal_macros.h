...
/* package Praticas-0.1.0.0 */
#ifndef VERSION_Praticas
#define VERSION_Praticas "0.1.0.0"
#endif /* VERSION_Praticas */
#ifndef MIN_VERSION_Praticas
#define MIN_VERSION_Praticas(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Praticas */
...
#define CURRENT_COMPONENT_ID "Praticas-0.1.0.0-inplace-Praticas"
